...
export function TrustSection() {
  const trustFeatures = [
    {
      title: "Natural Conversational Speed",
      description:
        "Engineered for conversational cadence without awkward delays, pauses, or overlapping interruptions.",
      icon: Zap,
    },
    {
          ...
          {trustFeatures.map((item, index) => {
            ...
            return (
              <motion.div
                ...
                className="rounded-3xl p-7 bg-white dark:bg-zinc-900/60 border border-slate-200/80 dark:border-white/[0.08] shadow-sm hover:shadow-md transition-all duration-300"
              >
