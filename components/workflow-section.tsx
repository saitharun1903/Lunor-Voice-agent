      ...
      <div className="max-w-5xl mx-auto px-5 sm:px-8">
        ...
        <div className="max-w-3xl mb-16 sm:mb-24 text-left space-y-4">
          ...
          <motion.p
            ...
            className="type-sans-body-lg text-zinc-600 dark:text-zinc-400 leading-relaxed font-normal max-w-xl"
          >
        ...
        <div className="relative pt-6">
          ...
          <div className="hidden md:block absolute top-[4.2rem] left-12 right-12 h-[2px] bg-black/[0.08] dark:bg-white/[0.08] pointer-events-none z-0">
            <motion.div
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3">
                    <div className="w-9 h-9 rounded-xl bg-black/[0.04] dark:bg-white/[0.06] border border-black/[0.06] dark:border-white/[0.08] flex items-center justify-center text-blue-600 dark:text-blue-400">
