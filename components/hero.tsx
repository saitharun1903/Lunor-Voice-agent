    ...
    <section className="relative pt-24 pb-14 md:pt-32 md:pb-20 overflow-hidden">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-center">
          ...
          >
            <div className="relative w-full max-w-sm rounded-3xl p-6 structured-card text-center space-y-5 shadow-md">
              {/* Header Indicator */}
              <div className="flex items-center justify-between border-b border-black/[0.04] dark:border-white/[0.05] pb-3 text-xs">
                <span className="type-eyebrow text-zinc-500">Acoustic Signal</span>
              ...
              <div
                onClick={handleTalkToLunor}
                className="py-2 flex items-center justify-center cursor-pointer transition-transform duration-200 hover:scale-105"
                title="Click to try live voice demo"
              >
                <Lunor3DMark size={120} />
              </div>

              {/* 3-Stage Signal Flow: CALL -> UNDERSTAND -> ACT */}
              <div className="p-3.5 rounded-2xl bg-black/[0.02] dark:bg-white/[0.03] border border-black/[0.03] dark:border-white/[0.04] space-y-1.5">
                <div className="flex items-center justify-center gap-2 type-eyebrow text-zinc-700 dark:text-zinc-300 font-semibold">
                  <span>CALL</span>
              ...
              <button
                onClick={handleTalkToLunor}
                className="w-full flex items-center justify-center gap-2 py-2.5 rounded-xl text-xs font-semibold btn-outline-secondary"
              >
