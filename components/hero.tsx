      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-8 space-y-7 text-left">
            ...
            {/* 2. Bold Editorial Display Headline with Controlled Line Wrapping */}
            <motion.h1
              initial={{ opacity: 0, y: 12 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.45, delay: 0.06 }}
              className="type-display text-zinc-950 dark:text-white max-w-3xl"
            >
              AUTOMATE THE{" "}
            ...
            <motion.p
              ...
              className="type-body-lg text-zinc-600 dark:text-zinc-300 max-w-2xl"
            >
              {subheadline}
            </motion.p>
            ...
            >
              <button
                ...
                className="flex items-center justify-center gap-2 px-7 py-3.5 rounded-full type-btn btn-solid-primary shadow-lg"
              >
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 px-7 py-3.5 rounded-full type-btn btn-outline-secondary"
              >
            ...
            <motion.div
              ...
              className="pt-4 flex flex-wrap items-center gap-6 sm:gap-8 text-xs text-zinc-500 dark:text-zinc-400 border-t border-black/[0.05] dark:border-white/[0.06]"
            >
              <div className="flex items-center gap-2">
                <Zap className="w-3.5 h-3.5 text-blue-600 dark:text-blue-400" />
                <span className="font-medium">Sub-400ms Turn Cadence</span>
              </div>
              <div className="flex items-center gap-2">
                <Shield className="w-3.5 h-3.5 text-emerald-600 dark:text-emerald-400" />
                <span className="font-medium">SIP Warm Transfers</span>
              </div>
              <div className="flex items-center gap-2">
                <Clock className="w-3.5 h-3.5 text-zinc-700 dark:text-zinc-300" />
                <span className="font-medium">100% Inbound Capture</span>
              </div>
            </motion.div>
          </div>
          ...
          >
            <div className="relative w-full max-w-sm rounded-3xl p-8 structured-card text-center space-y-6">
              <div className="flex items-center justify-between border-b border-black/[0.05] dark:border-white/[0.06] pb-3 text-xs text-zinc-500">
                <span className="type-label-tech">ACOUSTIC CORE</span>
                <span className="flex items-center gap-1.5 type-label-tech text-emerald-600 dark:text-emerald-400">
              ...
              <div className="space-y-1.5 text-left">
                ...
                <p className="type-body-sm text-zinc-500 dark:text-zinc-400 leading-relaxed">
