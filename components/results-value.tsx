        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {outcomes.map((outcome) => {
            ...
            return (
              <div
                key={outcome.title}
                className="rounded-3xl p-7 bg-white dark:bg-zinc-900/60 border border-slate-200/80 dark:border-white/[0.08] shadow-sm hover:shadow-md transition-all duration-200 flex flex-col justify-between"
              >
                <div>
